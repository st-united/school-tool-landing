...
import LogoAILeaders from "../../assets/aileadervn.png";
import LogoGDG from "../../assets/gdg.png";
import LogoUni from "../../assets/skhcn1.png";
import image from "../../assets/koreanST.png";
  ...
  return (
    <section className="relative w-full bg-[#fcf7f6] overflow-hidden sm:min-h-min h-full">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 md:px-8">
        {/* Top logos */}
        <div className="grid grid-cols-3 gap-4 pt-8 sm:pt-10 md:pt-12">
          {/* Left block */}
          ...
          <div className="text-center">
            ...
            <div className="mt-2 flex items-center justify-center">
              <Brand src={LogoAILeaders} alt="AI Leaders" />
              <Brand src={LogoGDG} alt="Google Developer Group Miền Trung" />
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <div className="mt-2 flex items-center justify-center">
              <Brand src={LogoUni} alt="Đơn vị Bảo trợ" />
            </div>
          </div>
        </div>
      ...
      <section className="relative w-full overflow-hidden">
        {/* ===== Content container ===== */}
        <div className="relative z-10 py-10 px-16 sm:py-14 md:py-16">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-10 mt-4 md:mt-2 items-center">
            <div className="col-span-12 lg:col-span-7 md:justify-items-end">
              ...
              {/* Body */}
              <div className="mt-5 space-y-4 text-[#FF854D] md:text-end">
