  ...
  return (
    ...
    >
      ...
      <img
        ...
        alt=""
        aria-hidden
        className="pointer-events-none select-none absolute right-20 top-[20rem] w-[9rem] rounded-full inset-shadow-xl"
      />
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 md:px-8 py-12 sm:py-16 md:py-20">
        ...
        <TitleBlock
          title="ĐỐI TÁC"
          subtitle="DevPlus kết nối với nhiều đối tác doanh nghiệp uy tín để đảm bảo cơ hội thực tập và đầu ra việc làm cho sinh viên."
        />
        <div className="mt-6 grid grid-cols-2 gap-10">
          <div>
            <SectionLabel text="Đơn vị tổ chức" />
            <CardTwoGrid items={ORGANIZERS_LEFT} />
          </div>
          <div>
            <SectionLabel text="Đơn vị tổ chức / đồng hành" />
            <CardTwoGrid items={ORGANIZERS_RIGHT} />
          </div>
        </div>
